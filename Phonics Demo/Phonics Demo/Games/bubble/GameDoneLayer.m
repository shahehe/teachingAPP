...
+ (CCScene*) sceneWithBackScene:(CCScene *)_scene
{
    ...
    GameDoneLayer *layer = [[[self alloc] initWithBackScene:_scene] autorelease];
...
//        coinLabel.visible = NO;
        ...
        firework = [CCParticleSystemQuad particleWithFile:@"bubble_firework.plist"];
