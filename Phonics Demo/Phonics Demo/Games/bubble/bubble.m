...
- (BOOL) isObjectPerformRotate
{
    return !(_object.ignoreBodyRotation);
}

- (void) setObjectPerformRotation:(BOOL)isObjectPerformRotate
{
    _object.ignoreBodyRotation = !isObjectPerformRotate;
}
