...
{
    if (_touchpriority == touchpriority) return;
    else _touchpriority = touchpriority;
    
    CCTouchDispatcher *t = [[CCDirector sharedDirector] touchDispatcher];
    [t removeDelegate:self];
    [t addTargetedDelegate:self priority:touchpriority swallowsTouches:YES];
}
